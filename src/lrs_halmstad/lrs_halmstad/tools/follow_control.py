...
def parse_args() -> FollowControlConfig:
    ...
    parser.add_argument("--step-z-min", type=float, default=5.0, help="Keyboard/scripted follow_z_offset_m change per step, default: 1")
    ...
    parser.add_argument("--max-z-min", type=float, default=200.0, help=argparse.SUPPRESS)
