...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'maps'), ['../../maps/waypoints_baylands_groups.csv']),
    ...
    entry_points={
        'console_scripts': [
            ...
            "support_hazard_projector = lrs_halmstad.perception.support_hazard_projector:main",
            ...
            "simulation_uav_localization = lrs_halmstad.sim.simulation_uav_localization:main",
