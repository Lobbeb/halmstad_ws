...
class GazeboPoseTcpBridge(Node):
    def __init__(self):
        ...
        self.declare_parameter("odom_topic", "/x2_ugv/odom")
        self.declare_parameter("model_name", "x2_ugv")
        self.declare_parameter("odom_topics", ["/x2_ugv/odom", "/bebop1/odom"])
        self.declare_parameter("model_names", ["x2_ugv", "bebop1"])
