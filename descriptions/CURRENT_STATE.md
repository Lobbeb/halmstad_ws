...
## ***WARNING***: **This file might be outdated**

**Don't source it as *ground truth*.**
...
- OMNeT is the one deliberate exception: its pose bridge now uses raw `/<ugv>/platform/odom`
